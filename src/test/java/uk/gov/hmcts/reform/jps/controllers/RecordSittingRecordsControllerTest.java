    ...
    void shouldCreateSittingRecordsWhenRequestIsValid() throws Exception {
        ...
        mockMvc.perform(post("/recordSittingRecords/{hmctsServiceCode}", TEST_SERVICE)
            ...
            .andExpectAll(
                ...
                jsonPath("$.errorRecords[0].postedRecord.contractTypeId").value("1L"),
                ...
                jsonPath("$.errorRecords[1].postedRecord.contractTypeId").value("1L"),
                ...
                jsonPath("$.errorRecords[2].postedRecord.contractTypeId").value("1L"),
